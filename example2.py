...
async def draw_rectangle(x1: int, y1: int, x2: int, y2: int) -> dict:
    ...
    try:
        ...
        # return {"content": [TextContent(type="text", text=f"Focus of the window : {paint_window.has_focus()}")]}
        ...
        paint_window.click_input(coords=(530, 85))
        time.sleep(0.2)
        ...
        # canvas.press_mouse_input(coords=(x1+canvas_x_offset, y1+canvas_x_offset))
        # # time.sleep(0.2)
        # canvas.move_mouse_input(coords=(x2+canvas_x_offset, y2+canvas_x_offset))
        # # time.sleep(0.2)
        # canvas.release_mouse_input(coords=(x2+canvas_x_offset, y2+canvas_x_offset))
        # time.sleep(0.2)
        ...
        # Starting point
        canvas.press_mouse_input(
            coords=(x1 + canvas_x_offset, y1 + canvas_y_offset),
            button='left'
        )
        time.sleep(0.5)  # Wait after pressing
        
        # Move to end point
        canvas.move_mouse_input(
            coords=(x2 + canvas_x_offset, y2 + canvas_y_offset)
        )
        time.sleep(0.5)  # Wait before release
        
        # Release at end point
        canvas.release_mouse_input(
            coords=(x2 + canvas_x_offset, y2 + canvas_y_offset),
            button='left'
        )
        time.sleep(0.5)  # Wait for drawing to complete
...
async def add_text_in_paint(text: str) -> dict:
    ...
    try:
        ...
        paint_window.click_input(coords=(592, 82))
        time.sleep(0.2)
        ...
        canvas.click_input(coords=(700, 700))
...
async def open_paint() -> dict:
    ...
    try:
        ...
        print(paint_window.has_focus())

        return {
            "content": [
                TextContent(
                    type="text",
                    text=f"Paint opened successfully on secondary monitor and maximized"
                )
            ]
        }
    except Exception as e:
